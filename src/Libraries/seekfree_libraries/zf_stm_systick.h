...
//------------------------------------以下宏定义用于延时------------------------------------
#define systick_delay_ms(time)	systick_delay(STM0, time*1000000)           //设置延时时间  单位ms
#define systick_delay_us(time)	systick_delay(STM0, time*1000)              //设置延时时间  单位us
#define systick_delay_ns(time)	systick_delay(STM0, time)   		        //设置延时时间  单位ns
