...
//------------PIT中断参数相关定义------------
#define CCU6_0_CH0_INT_SERVICE	IfxSrc_Tos_cpu2 //定义CCU6_0 PIT通道0中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_dma   不可设置为其他值
...
#define ERU_CH0_CH4_INT_PRIO  	41	//定义ERU通道0和通道4中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样

//通道1与通道5是公用一个中断函数 在中断内部通过标志位判断是谁触发的中断
#define ERU_CH1_CH5_INT_SERVICE IfxSrc_Tos_cpu0	//定义ERU通道1和通道5中断服务类型，同上
#define ERU_CH1_CH5_INT_PRIO  	40	//定义ERU通道1和通道5中断优先级 同上
...
//------------DMA中断参数相关定义------------
#define	ERU_DMA_INT_SERVICE     IfxSrc_Tos_cpu1	//ERU触发DMA中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_dma   不可设置为其他值
...
#define UART1_TX_INT_PRIO       19
#define UART1_RX_INT_PRIO       20
#define UART1_ER_INT_PRIO       21
...
#define UART3_RX_INT_PRIO       14
#define UART3_ER_INT_PRIO       15
